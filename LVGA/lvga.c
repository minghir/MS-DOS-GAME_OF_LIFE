...
char chars_15[255][15];// = { [65] = "111101111101101", [66] = "110101111101110", [80] = "111101111100100"};

void init_chars_15(){
	
	strcpy(chars_15['A'],"111101111101101");
	strcpy(chars_15['B'],"110101111101110");
	strcpy(chars_15['C'],"111100100100111");
	strcpy(chars_15['D'],"110101101101110");
	strcpy(chars_15['E'],"111100110100111");
	strcpy(chars_15['F'],"111100110100100");
	strcpy(chars_15['G'],"111100101101111");
	strcpy(chars_15['H'],"101101111101101");
	strcpy(chars_15['I'],"010010010010010");
	strcpy(chars_15['J'],"011001001101111");
	strcpy(chars_15['K'],"101101110101101");
	strcpy(chars_15['L'],"100100100100111");
	strcpy(chars_15['M'],"101101111111101");
	strcpy(chars_15['N'],"101111111101101");
	strcpy(chars_15['O'],"111101101101111");
	strcpy(chars_15['P'],"111101111100100");
	strcpy(chars_15['Q'],"111101101111010");
	strcpy(chars_15['R'],"111101110101101");
	strcpy(chars_15['S'],"111100111001111");
	strcpy(chars_15['T'],"111010010010010");
	strcpy(chars_15['U'],"101101101101111");
	strcpy(chars_15['V'],"101101101101010");
	strcpy(chars_15['W'],"101101111111010");
	strcpy(chars_15['X'],"101111010111101");
	strcpy(chars_15['Y'],"101101010010010");
	strcpy(chars_15['Z'],"111001010100111");
	strcpy(chars_15['1'],"010010010010010");
	strcpy(chars_15['2'],"111001111100111");
	strcpy(chars_15['3'],"111001011001111");
	strcpy(chars_15['4'],"101101111001001");
	strcpy(chars_15['5'],"111100111001111");
	strcpy(chars_15['6'],"111100111101111");
	strcpy(chars_15['7'],"111001001001001");
	strcpy(chars_15['8'],"111101111101111");
	strcpy(chars_15['9'],"111101111001001");
	strcpy(chars_15['0'],"111101101101111");
	strcpy(chars_15[':'],"000010000010000");
	strcpy(chars_15['x'],"000000101010101");
	strcpy(chars_15['*'],"000101010101000");
	strcpy(chars_15['+'],"000010111010000");
	strcpy(chars_15['-'],"000000111000000");
	strcpy(chars_15['='],"000111000111000");
	strcpy(chars_15['m'],"111110100000000");
	strcpy(chars_15['.'],"000000000110110");
	strcpy(chars_15['o'],"000111101111000"); // but clear table	
	strcpy(chars_15['h'],"000101111101000"); // but next gen
	strcpy(chars_15['p'],"000101101101000"); // but pause 
	strcpy(chars_15['g'],"000110111110000"); // but play
	strcpy(chars_15[' '],"000000000000000"); // but play

	
}

void put_char_15 (int x, int y, char c, int color, int bg_color ){
...
void put_str_15 (int x, int y, char *str, int color, int bg_color){
	int i;
	
	for(i = 0;i<strlen(str);i++){
		put_char_15(x,y,str[i],color,bg_color);
		x=x+4;
	}
}
/*
void button(int x, int y, char c, int pressed, int color, int bg_color){
	rect_fill(x,y,(x+8),y+8,bg_color);
	rect_fast(x,y,(x+8),y+8,color);
	put_char_15(x+3,y+1,c,color, bg_color);
...
void button(Button b){
	...
	rect_fill(b.x,b.y,(b.x+8),b.y+8,b.bg_color);
	rect_fast(b.x,b.y,(b.x+8),b.y+8,26);
	put_char_15(b.x+3,b.y+1,b.c,b.color, b.bg_color);
}
